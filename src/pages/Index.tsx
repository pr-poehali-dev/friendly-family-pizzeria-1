...
const Index = () => {
  ...
  const menuCategories = [
    ...
    },
    {
      title: "Пицца",
      items: [
        { name: "Чикен бекон", description: "Сыр моцарелла, соус белый, соус сырный, соус барбекю, бекон, обжаренный цыпленок, томаты свежие", price: "850 руб." },
        { name: "Веронo", description: "Сыр моцарелла, соус из томатов, соус белый, обжаренный цыплёнок, шампиньоны", price: "850 руб." },
        { name: "Каприччо", description: "Сыр моцарелла, соус белый, соус из томатов, обжаренный цыплёнок, ветчина премиум, сервелат, перец сладкий свежий", price: "850 руб." },
        { name: "Пронто", description: "Сыр моцарелла, соус белый, соус ранч, обжаренный цыпленок, бекон, томаты свежие, грибы", price: "850 руб." },
        { name: "Гавайская", description: "Сыр моцарелла, соус белый, соус из томатов, обжаренный цыпленок, ананасы, томаты свежие", price: "850 руб." },
        { name: "Цезарь", description: "Курица, соус Цезарь, моцарелла, черри, лист салата, сухарики, пармезан", price: "850 руб." },
        { name: "Пепперони", description: "Сыр моцарелла, фирменный пицца-соус, соус белый, колбаски пепперони", price: "850 руб." },
        { name: "Наполи", description: "Сыр моцарелла, соус белый, ветчина премиум, томаты свежие", price: "850 руб." },
        { name: "Ассорти", description: "Сыр моцарелла, соус из томатов, соус белый, сервелат, грибы, томаты свежие", price: "850 руб." },
        { name: "Сицилийская", description: "Сыр моцарелла, соус белый, сервелат, бекон, грибы, томаты свежие, перец сладкий свежий, оливки", price: "850 руб." }
      ]
    },
    {
      title: "Пицца острая",
      items: [
        { name: "Крейзи пиг", description: "Сыр моцарелла, жгучий соус сальса, кетчуп, соус белый, соус горчичный, бекон премиум, перец халапеньо, перец жгучий чили", price: "850 руб." }
      ]
    },
    {
      title: "Пицца без мяса",
      items: [
        { name: "Маргарита", description: "Сыр моцарелла, соус белый, соус из томатов, грибы, томаты свежие", price: "850 руб." },
        { name: "Сырная элитная", description: "Сыр моцарелла, сыр Дорблю, сыр пармезан, сыр фета, соус белый", price: "850 руб." },
        { name: "Сырная новая", description: "Сыр моцарелла двойная порция, сыр фета, соус белый, прованские травы", price: "850 руб." }
      ]
    },
    {
      title: "Пицца с морепродуктами",
      items: [
        { name: "Маринара", description: "Сыр моцарелла, соус белый, соус из томатов, морской коктейль из морепродуктов, томаты свежие, оливки", price: "900 руб." }
      ]
    },
    {
      title: "Закуски",
