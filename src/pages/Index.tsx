  ...
  const menuCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Запеченная филадельфия", description: "рис, нори, сыр, лосось, фирменный соус, унаги, кунжут", price: "450 руб.", image: "https://cdn.poehali.dev/files/724b691b-aa4a-48e1-bcd3-3916bc797b28.png" },
