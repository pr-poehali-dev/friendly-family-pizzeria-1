...
const Index = () => {
  ...
  const menuCategories = [
    ...
    },
    {
      title: "Пицца",
      items: [
        { name: "Чикен бекон", description: "Сыр моцарелла, соус белый, соус сырный, соус барбекю, бекон, обжаренный цыпленок, томаты свежие", price: "40см - 850р." },
        { name: "Веронo", description: "Сыр моцарелла, соус из томатов, соус белый, обжаренный цыплёнок, шампиньоны", price: "40см - 850р." },
        { name: "Каприччо", description: "Сыр моцарелла, соус белый, соус из томатов, обжаренный цыплёнок, ветчина премиум, сервелат, перец сладкий свежий", price: "40см - 850р." },
        { name: "Пронто", description: "Сыр моцарелла, соус белый, соус ранч, обжаренный цыпленок, бекон, томаты свежие, грибы", price: "40см - 850р." },
        { name: "Гавайская", description: "Сыр моцарелла, соус белый, соус из томатов, обжаренный цыпленок, ананасы, томаты свежие", price: "40см - 850р." },
        { name: "Цезарь", description: "Курица, соус Цезарь, моцарелла, черри, лист салата, сухарики, пармезан", price: "38см - 850р." },
        { name: "Пепперони", description: "Сыр моцарелла, фирменный пицца-соус, соус белый, колбаски пепперони", price: "40см - 850р." },
        { name: "Наполи", description: "Сыр моцарелла, соус белый, ветчина премиум, томаты свежие", price: "40см - 850р." },
        { name: "Ассорти", description: "Сыр моцарелла, соус из томатов, соус белый, сервелат, грибы, томаты свежие", price: "40см - 850р." },
        { name: "Сицилийская", description: "Сыр моцарелла, соус белый, сервелат, бекон, грибы, томаты свежие, перец сладкий свежий, оливки", price: "40см - 850р." }
      ]
    },
    {
      title: "Пицца острая",
      items: [
        { name: "Крейзи пиг", description: "Сыр моцарелла, жгучий соус сальса, кетчуп, соус белый, соус горчичный, бекон премиум, перец халапеньо, перец жгучий чили", price: "40см - 850р." }
      ]
    },
    {
      title: "Пицца без мяса",
      items: [
        { name: "Маргарита", description: "Сыр моцарелла, соус белый, соус из томатов, грибы, томаты свежие", price: "40см - 850р." },
        { name: "Сырная элитная", description: "Сыр моцарелла, сыр Дорблю, сыр пармезан, сыр фета, соус белый", price: "40см - 850р." },
        { name: "Сырная новая", description: "Сыр моцарелла двойная порция, сыр фета, соус белый, прованские травы", price: "40см - 850р." }
      ]
    },
    {
      title: "Пицца с морепродуктами",
      items: [
        { name: "Маринара", description: "Сыр моцарелла, соус белый, соус из томатов, морской коктейль из морепродуктов, томаты свежие, оливки", price: "40см - 900р." }
      ]
    },
    {
      title: "Закуски",
      items: [
        { name: "Картофель фри", description: "", price: "150р.-250р." },
        { name: "Картофель по-деревенски", description: "", price: "150р.-250р." },
        { name: "Кольца луковые", description: "", price: "100р.-200р." },
        { name: "Наггетсы куриные", description: "", price: "100р.-200р." },
        { name: "Сырные палочки", description: "", price: "100р.-250р." },
        { name: "Крылья цыпленка запеченные", description: "", price: "300р.-460р." }
      ]
    },
    {
      title: "Салаты",
      items: [
        { name: "Салат «Гавайский»", description: "Сочный салат с нежным филе грудки, с ананасами и пекинской капустой в фирменном соусе", price: "300р.-350р." },
        { name: "Салат «Греческий»", description: "Греческий овощной салат с сыром фета и маслинами", price: "300р.-350р." },
        { name: "Салат «Грибной с ветчиной»", description: "Сытный салат с грибами, ветчиной, томатами, огурцами и красным луком в майонезной заправке", price: "300р.-400р." },
        { name: "Салат «Оливье»", description: "Классический оливье", price: "250р.-280р." },
        { name: "Салат «Цезарь с курицей»", description: "Классический салат «Цезарь с курицей», микс салата, соус Цезарь, черри, пармезан", price: "250р.-400р." },
        { name: "Салат «Цезарь с креветкой»", description: "Айсберг, соус Цезарь, черри, пармезан, сухарики", price: "250р.-500р." }
      ]
    },
    {
      title: "Сеты",
