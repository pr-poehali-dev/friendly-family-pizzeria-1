  ...
  const menuCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Сет «Дружная семья» (56шт)", description: "филадельфия, калифорния краб, запеченный с креветкой, запеченный с лососем, запеченная киото, темпура тунец, ролл с огурцом", price: "1600 руб.", image: "https://cdn.poehali.dev/files/e9956974-1b81-426d-9a28-631916dada5f.png" },
